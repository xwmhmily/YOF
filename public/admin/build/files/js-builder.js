jQuery(function($) {
 ...
 var script_list = [];
 $.ajax({url: "../assets/js/ace/scripts.json", cache:false, dataType: 'json'}).done(function(list) {
 ...
 function get_file(index) {
	...
	$.ajax({url: "../assets/js/ace/" + script_file, cache: false, dataType: 'text'})
	.done(function(content) {
		...
		if(script_file.match(/\-1\.js$/)) {
			...
			$.ajax({url: "../assets/js/ace/" + alt_script, cache: false, dataType: 'text'})
			.done(function(content) {
